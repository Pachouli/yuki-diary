...
public class DiaryEditor extends Activity {
	...
	public static final String DELET_DIARY_ACTION
	="andy.ham..DiaryEditor.action.DELETE_DIARY";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		else if(DELET_DIARY_ACTION.equals(action)){
			mState = STATE_DELETE;
			setTitle("删除日记");
		}
		else {
	...
	private  void  deleteDiary(){
        getContentResolver().
                delete(Fields.DiaryColumns.CONTENT_URI, null,null);
	}
